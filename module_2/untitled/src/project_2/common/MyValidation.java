    ...
    public static boolean isValidFormatBirthday(String birthday) {
        ...
        if (Pattern.matches(regex, birthday)) {
            ...
            switch (Integer.parseInt(birthdays[1])) {
                ...
                case 10:
                case 12:
                    if (Integer.parseInt(birthdays[0]) < 32 && Integer.parseInt(birthdays[1]) < 32 && Integer.parseInt(birthdays[0]) > 0) {
                        return true;
                    } else {
                        return false;
                    }
                ...
                case 9:
                case 11:
                    if (Integer.parseInt(birthdays[0]) < 31 && Integer.parseInt(birthdays[1]) < 31 && Integer.parseInt(birthdays[0]) > 0) {
                        return true;
                    } else {
                        return false;
                    }
