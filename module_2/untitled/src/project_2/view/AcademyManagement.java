package project_2.view;

import project_2.common.MyValidation;
import project_2.controller.StudentController;
import project_2.controller.TeacherController;
...
public class AcademyManagement {
    ...
    public static Student inputStudent(Scanner sc) {
        ...
        do {
            ...
            if(name.isEmpty()) {
                ...
                System.out.println("Tên không chứa ký tự đặc biệt và số. Vui lòng nhập lại");
            } else {
                break;
            }
        } while (true);
    ...
    public static void searchStudent(StudentController studentController) {
        Scanner sc = new Scanner(System.in);
        System.out.println("Nhập tên cần tìm");
        String keyword = sc.nextLine();
        List<Student> result = studentController.seacrhByName(keyword);
        if (result.isEmpty()) {
            System.out.println("Không tìm thấy sinh viên");
            return;
        }
        ...
        do {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    searchTeacher(teacherController);
                    break;
                case 6:
                    System.exit(0);
            }
    ...
    public static void searchTeacher(TeacherController teacherController) {
        Scanner sc = new Scanner(System.in);
        System.out.println("Nhập tên cần tìm");
        String keyword = sc.nextLine();
    ...
    public static void editTeacher(TeacherController teacherController) {
        ...
        Teacher updatedTeacher = new Teacher(editId, name, email, localDate, salary);
