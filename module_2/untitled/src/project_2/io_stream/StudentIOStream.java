...
public class StudentIOStream {
    private static final String URL = "src/project_2/data/student.csv";

    public static void writeStudentInfoFile(Student student) {
    ...
    public static void writeListStudentInfoFile(List<Student> students) {
